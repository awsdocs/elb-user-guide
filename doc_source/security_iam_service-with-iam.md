# How Elastic Load Balancing works with IAM<a name="security_iam_service-with-iam"></a>
...
## Service roles for Elastic Load Balancing<a name="security_iam_service-with-iam-roles-service"></a>
